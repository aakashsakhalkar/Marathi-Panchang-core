...
exports.SAMVATSARA_NAMES = void 0;
exports.calculateSamvatInfo = calculateSamvatInfo;
exports.SAMVATSARA_NAMES = [
...
function calculateSamvatInfo(year, month, day) {
    ...
    const samvatsaraObj = exports.SAMVATSARA_NAMES[samvatsaraIndex];
    return {
        shakaSamvat,
