...
exports.NAKSHATRA_DATA = void 0;
exports.calculateNakshatraInfo = calculateNakshatraInfo;
...
function calculateNakshatraInfo(year, month, day, sunriseUTCHours, tzOffsetHours) {
    ...
    const nakData = exports.NAKSHATRA_DATA[index - 1];
    const rashi = (0, moon_1.getMoonRashi)(pos.moonNirayanaDeg);
    // Pada / Charan (1 to 4)
